...
--
-- Table structure for table `menu_ingridiant`
--

DROP TABLE IF EXISTS `menu_ingridiant`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `menu_ingridiant` (
  `id` int(11) NOT NULL,
  `menu_name` varchar(45) DEFAULT NULL,
  `menu_ingridiantcol` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `menu_ingridiant`
--

LOCK TABLES `menu_ingridiant` WRITE;
/*!40000 ALTER TABLE `menu_ingridiant` DISABLE KEYS */;
/*!40000 ALTER TABLE `menu_ingridiant` ENABLE KEYS */;
UNLOCK TABLES;
...
--
/*!50003 DROP PROCEDURE IF EXISTS `menu_ingridiat` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `menu_ingridiat`(
    IN `query_type` VARCHAR(20),
    IN `_menu_name` VARCHAR(20),
    IN `_menu_price` VARCHAR(15),
    IN `_menu_ingridiat` VARCHAR(255) -- Adjusted size to handle longer ingredient lists
)
BEGIN
    ...
    -- Insert ingredients if query_type is 'insert_ingriate'
    ELSEIF query_type = "insert_ingriate" THEN 
        -- Loop through each ingredient in the comma-separated list
        SET ing_end = LOCATE(',', _menu_ingridiat, ing_start);
        
        WHILE ing_end > 0 DO
            -- Extract each ingredient and trim it if necessary
            SET ingredient = TRIM(SUBSTRING(_menu_ingridiat, ing_start, ing_end - ing_start));
            
            -- Insert into `menu_ingridiant` table
            INSERT INTO `menu_ingridiant`(
                menu_name,
                menu_ingridiantcol
            ) VALUES (
                _menu_name,
        ...
        SET ingredient = TRIM(SUBSTRING(_menu_ingridiat, ing_start));
...
-- Dump completed on 2024-11-02 13:47:50
